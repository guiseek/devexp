module.exports = {
  ...
  scopes: [
    { name: 'shared-util-dom', description: '@dev-exp/util-dom' },
    { name: 'shared-api-path', description: '@dev-exp/api-path' },
    { name: 'shared-data-storage', description: '@dev-exp/data-storage' },
  ],
